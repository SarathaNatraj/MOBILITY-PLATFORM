...
-keep class com.sample.yogiraj.instagram.demo.data.model.** { *; }

# Keep Remote Model classes AS-IS
-keep class com.sample.yogiraj.instagram.demo.data.remote.model.** { *; }

# Keep Remote Request Model classes AS-IS
-keep class com.sample.yogiraj.instagram.demo.data.remote.request.** { *; }

# Keep Remote Response Model classes AS-IS
-keep class com.sample.yogiraj.instagram.demo.data.remote.response.** { *; }

# Keep Local Database Entity classes AS-IS
-keep class com.sample.yogiraj.instagram.demo.data.local.db.entity.** { *; }
