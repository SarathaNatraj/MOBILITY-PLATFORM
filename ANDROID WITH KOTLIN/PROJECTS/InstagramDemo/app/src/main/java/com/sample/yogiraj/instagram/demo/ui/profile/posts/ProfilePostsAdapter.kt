...
import com.sample.yogiraj.instagram.demo.ui.base.BaseAdapter
import com.sample.yogiraj.instagram.demo.ui.profile.posts.ProfilePostsAdapter.Listener

/**
 * [BaseAdapter] subclass for the [androidx.recyclerview.widget.RecyclerView]
 * in [com.sample.yogiraj.instagram.demo.ui.profile.ProfileFragment].
 *
 * @param parentLifecycle [Lifecycle] of [com.sample.yogiraj.instagram.demo.ui.profile.ProfileFragment]
...
class ProfilePostsAdapter(
    ...
    /**
     * Interface to be implemented by the Host [com.sample.yogiraj.instagram.demo.ui.profile.ProfileFragment]
