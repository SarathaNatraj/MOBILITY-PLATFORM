...
import com.sample.yogiraj.instagram.demo.ui.home.util.HomePostListUpdater
...
import com.sample.yogiraj.instagram.demo.utils.log.Logger
...
class HomeViewModel(
    ...
    /**
     * Called after the launch and completion of [com.sample.yogiraj.instagram.demo.ui.like.PostLikeActivity]
     * and [com.sample.yogiraj.instagram.demo.ui.detail.PostDetailActivity] for the Post with [postId].
     *
