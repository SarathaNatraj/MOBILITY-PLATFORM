...
import com.sample.yogiraj.instagram.demo.ui.base.BaseViewModel
...
import com.sample.yogiraj.instagram.demo.utils.common.Event
...
class MainSharedViewModel(
    ...
    /**
     * Called by the [com.sample.yogiraj.instagram.demo.ui.photo.PhotoFragment]
     * when a new Instagram Post is created.
     *
     * Publishes the [newPost] to the [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment]
     * and [com.sample.yogiraj.instagram.demo.ui.profile.ProfileFragment] to show,
     * and also navigates to the [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment].
     *
     ...
     * [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment] to handle.
     */
     ...
     * in [com.sample.yogiraj.instagram.demo.ui.profile.edit.EditProfileActivity].
     *
     ...
     * through [com.sample.yogiraj.instagram.demo.ui.profile.edit.EditProfileActivity].
     *
     * Triggers an event for the [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment]
     * and [com.sample.yogiraj.instagram.demo.ui.profile.ProfileFragment] to reload Profile information.
     */
     ...
     * [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment] or
     * [com.sample.yogiraj.instagram.demo.ui.profile.ProfileFragment].
     *
     * Triggers an event to launch the [com.sample.yogiraj.instagram.demo.ui.detail.PostDetailActivity]
     ...
     * [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment].
     *
     * Triggers an event to launch the [com.sample.yogiraj.instagram.demo.ui.like.PostLikeActivity]
     * supplying the required [post] details as Intent Extras.
     */
     ...
     * [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment] or
     * [com.sample.yogiraj.instagram.demo.ui.detail.PostDetailActivity].
     *
     * Triggers an event for the [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment]
     * and [com.sample.yogiraj.instagram.demo.ui.profile.ProfileFragment] to reload the List of Posts after
     ...
     * Triggers an event for the [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment] to reload
