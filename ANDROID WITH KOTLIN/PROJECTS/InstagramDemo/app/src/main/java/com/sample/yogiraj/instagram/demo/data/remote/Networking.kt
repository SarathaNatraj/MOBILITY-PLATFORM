...
package com.sample.yogiraj.instagram.demo.data.remote
...
object Networking {
    ...
    val httpLoggingInterceptor: () -> HttpLoggingInterceptor = {
        HttpLoggingInterceptor()
            .apply {
                ...
                level = if (com.sample.yogiraj.instagram.demo.BuildConfig.DEBUG) HttpLoggingInterceptor.Level.BODY
    ...
    fun <T : Any> createService(
        ...
        // Save the API Key
       // API_KEY = apiKey
        API_KEY ="IGQVJWRklaUGFScS1NMnBuZAFNVd25lNi1IQzl2RmtNZA0xiekJBNFpfOTVBWGJiM21hTXZABYktQV3JFbGVPamJfZATJPcTlrbVY1cEVxMlV6R0lGRTdzdHB4U2dMTnM4b2tCQVZADU0hnOU0xUm1QZAktfawZDZD"
        // Creating an Instance of Retrofit
        return Retrofit.Builder()
            .baseUrl("https://developers.facebook.com/apps/632372862085065/dashboard/") // URL on which every endpoint will be appended
