...
object GlideHelper {
    ...
    fun getAppropriateGlideRequests(
        context: Context
    ): com.sample.yogiraj.instagram.demo.utils.common.GlideRequests = when (context) {
        is FragmentActivity -> com.sample.yogiraj.instagram.demo.utils.common.GlideApp.with(context)
        is Fragment -> com.sample.yogiraj.instagram.demo.utils.common.GlideApp.with(context as Fragment)
        is View -> com.sample.yogiraj.instagram.demo.utils.common.GlideApp.with(context as View)
        else -> com.sample.yogiraj.instagram.demo.utils.common.GlideApp.with(context)
    }
