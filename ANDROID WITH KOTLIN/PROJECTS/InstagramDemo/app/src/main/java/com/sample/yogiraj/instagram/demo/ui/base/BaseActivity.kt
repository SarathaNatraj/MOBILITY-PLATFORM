...
import com.sample.yogiraj.instagram.demo.di.component.DaggerActivityComponent
...
abstract class BaseActivity<VM : BaseViewModel> : AppCompatActivity() {
    ...
    private fun buildActivityComponent(): ActivityComponent =
        com.sample.yogiraj.instagram.demo.di.component.DaggerActivityComponent.builder()
