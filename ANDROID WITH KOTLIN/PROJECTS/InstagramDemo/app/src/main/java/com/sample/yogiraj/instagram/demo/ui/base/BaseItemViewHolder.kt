...
import com.sample.yogiraj.instagram.demo.di.component.DaggerViewHolderComponent
...
import com.sample.yogiraj.instagram.demo.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, L : BaseAdapter.DefaultListener<T>, VM : BaseItemViewModel<T>, VB : ViewBinding>(
    ...
    private fun buildViewHolderComponent(): ViewHolderComponent =
        com.sample.yogiraj.instagram.demo.di.component.DaggerViewHolderComponent.builder()
