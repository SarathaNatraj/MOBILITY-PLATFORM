...
import com.sample.yogiraj.instagram.demo.ui.home.posts.PostsAdapter.Listener

/**
 * [BaseAdapter] subclass for the [androidx.recyclerview.widget.RecyclerView]
 * in [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment].
 *
 * @param parentLifecycle [Lifecycle] of [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment]
...
class PostsAdapter(
    ...
    /**
     * Interface to be implemented by the Host [com.sample.yogiraj.instagram.demo.ui.home.HomeFragment]
