...
import com.sample.yogiraj.instagram.demo.di.component.DaggerGlideDependencyComponent
import com.sample.yogiraj.instagram.demo.di.component.GlideDependencyComponent
import com.sample.yogiraj.instagram.demo.di.module.GlideDependencyModule
...
class ApplicationGlideModule : AppGlideModule() {
    ...
    private fun buildGlideDependencyComponent(context: Context): GlideDependencyComponent =
        com.sample.yogiraj.instagram.demo.di.component.DaggerGlideDependencyComponent.builder()
