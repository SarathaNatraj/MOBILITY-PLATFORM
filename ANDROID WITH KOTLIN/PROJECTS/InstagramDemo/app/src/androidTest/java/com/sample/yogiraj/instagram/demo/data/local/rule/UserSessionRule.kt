...
package com.sample.yogiraj.instagram.demo.data.local.rule
...
class UserSessionRule(private val componentRule: TestComponentRule) : ExternalResource() {
    ...
    override fun before() {
        ...
        userRepository.saveCurrentUser(com.sample.yogiraj.instagram.demo.data.local.rule.UserSessionRule.Companion.signedInUser)
    }
