...
package com.sample.yogiraj.instagram.demo.di.rule

import android.content.Context
import com.sample.yogiraj.instagram.demo.InstagramApplication
import com.sample.yogiraj.instagram.demo.di.component.DaggerTestComponent
import com.sample.yogiraj.instagram.demo.di.component.TestComponent
import com.sample.yogiraj.instagram.demo.di.module.ApplicationTestModule
...
class TestComponentRule(private val context: Context) : ExternalResource() {
     ...
     * as the [com.sample.yogiraj.instagram.demo.di.component.ApplicationComponent] for Testing.
     */
    private fun setupDaggerTestComponentInApplication() {
        (context.applicationContext as InstagramApplication).run {
            testComponent = com.sample.yogiraj.instagram.demo.di.component.DaggerTestComponent.builder()
